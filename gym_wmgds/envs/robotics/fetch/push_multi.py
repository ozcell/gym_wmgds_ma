...
MODEL_OBSTACLE_SIDE_XML_PATH = os.path.join('fetch', 'push_obstacle_side_multi.xml')
MODEL_OBSTACLE_MIDDLE_XML_PATH = os.path.join('fetch', 'push_obstacle_middle_multi.xml')
MODEL_OBSTACLE_DOUBLE_XML_PATH = os.path.join('fetch', 'push_obstacle_double_multi.xml')
MODEL_OBSTACLE_MAZE_XML_PATH = os.path.join('fetch', 'push_obstacle_maze_multi.xml')
...
class FetchPushObstacleSideGapMultiEnv(fetch_multi_env.FetchMultiEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse', n_objects=1, obj_action_type=[0,1,2], observe_obj_grp=False, obj_range=0.15):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
        ...
        fetch_multi_env.FetchMultiEnv.__init__(
            self, MODEL_OBSTACLE_SIDE_XML_PATH, block_gripper=False, n_substeps=20,
...
class FetchPushObstacleMiddleGapMultiEnv(fetch_multi_env.FetchMultiEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse', n_objects=1, obj_action_type=[0,1,2], observe_obj_grp=False, obj_range=0.15):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
        ...
        fetch_multi_env.FetchMultiEnv.__init__(
            self, MODEL_OBSTACLE_MIDDLE_XML_PATH, block_gripper=False, n_substeps=20,
            gripper_extra_height=0.2, target_in_the_air=False, target_stacked=False, target_offset=0.0,
            obj_range=obj_range, target_range=0.15, distance_threshold=0.05,
            initial_qpos=initial_qpos, reward_type=reward_type,
            n_objects=n_objects, obj_action_type=obj_action_type, observe_obj_grp=observe_obj_grp,
...
class FetchPushObstacleDoubleGapMultiEnv(fetch_multi_env.FetchMultiEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse', n_objects=1, obj_action_type=[0,1,2], observe_obj_grp=False, obj_range=0.15):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
        ...
        fetch_multi_env.FetchMultiEnv.__init__(
            self, MODEL_OBSTACLE_DOUBLE_XML_PATH, block_gripper=False, n_substeps=20,
            gripper_extra_height=0.2, target_in_the_air=False, target_stacked=False, target_offset=0.0,
            obj_range=obj_range, target_range=0.15, distance_threshold=0.05,
            initial_qpos=initial_qpos, reward_type=reward_type,
            n_objects=n_objects, obj_action_type=obj_action_type, observe_obj_grp=observe_obj_grp,
            obj_range_lower=[-0.15,-0.25], obj_range_upper=[0.15,-0.15],
            target_range_lower=[-0.15,0.125,0.00], target_range_upper=[0.15,0.25,0.00],
            )        
        utils.EzPickle.__init__(self)


class FetchPushObstacleMazeMultiEnv(fetch_multi_env.FetchMultiEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse', n_objects=1, obj_action_type=[0,1,2], observe_obj_grp=False, obj_range=0.15):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
        ...
        fetch_multi_env.FetchMultiEnv.__init__(
            self, MODEL_OBSTACLE_MAZE_XML_PATH, block_gripper=False, n_substeps=20,
            gripper_extra_height=0.2, target_in_the_air=False, target_stacked=False, target_offset=0.0,
            obj_range=obj_range, target_range=0.15, distance_threshold=0.05,
            initial_qpos=initial_qpos, reward_type=reward_type,
            n_objects=n_objects, obj_action_type=obj_action_type, observe_obj_grp=observe_obj_grp,
            obj_range_lower=[-0.175,-0.275], obj_range_upper=[-0.10,0],
            target_range_lower=[0.10,-0.275,0.00], target_range_upper=[0.175,0,0.00],
