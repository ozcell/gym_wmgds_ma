...
class FetchPickAndPlaceMaRobSeqEnv(fetch_marob_env_seq.FetchMaRobEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse', n_objects=1, obj_action_type=[0,1,2], observe_obj_grp=False, obj_range=0.15, n_robots=2, widerangeobj=False):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
            'robot0:slide2': 0.0,
